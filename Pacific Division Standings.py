...
output = ""
if standings_by_division and "Pacific" in standings_by_division:
    output += "\nPacific Division Standings:\n"
    for team in standings_by_division["Pacific"]:
        output += f"{team['Team']}, PTS: {team['PTS']}\n"
else:
    output = "Unable to retrieve Pacific Division standings."
