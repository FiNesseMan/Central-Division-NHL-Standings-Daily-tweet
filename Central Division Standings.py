...
output = ""
if standings_by_division and "Central" in standings_by_division:
    output += "\nCentral Division Standings:\n"
    for team in standings_by_division["Central"]:
        output += f"{team['Team']}, PTS: {team['PTS']}\n"
else:
    output = "Unable to retrieve Central Division standings."
