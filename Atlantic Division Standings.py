...
output = ""
if standings_by_division and "Atlantic" in standings_by_division:
    output += "\nAtlantic Division Standings:\n"
    for team in standings_by_division["Atlantic"]:
        output += f"{team['Team']}, PTS: {team['PTS']}\n"
else:
    output = "Unable to retrieve Atlantic Division standings."
